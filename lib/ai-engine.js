...
7. [PERTANYAAN ESAI TEKNIS & SCREENING (METODE STAR)]:
   - Contoh pertanyaan: "Describe 1 high traffic, latency sensitive backend system you have worked on", "Tell me about a challenging project", "Why do you want to join us?", "Ceritakan pengalaman...":
     ...
     * Terapkan metode STAR (Situation, Task, Action, Result) dengan detail arsitektur teknis nyata dari CV:
       - Context: High-throughput Go/Fiber backend microservices, Shopee Open API rate-limiting challenges, asynchronous order-ingestion pipeline, Hybrid RAG Marketplace Intelligence, or Real-time Safety PPE detection with YOLO26 & ONNX FP16.
...
9. [ATURAN MUTLAK BATAS KARAKTER (MAXLENGTH / CHARACTER LIMITS)]:
   - Jika suatu kolom dalam 'DAFTAR KOLOM FORMULIR' memiliki atribut 'maxLength' (misal: maxLength: 100 atau maxLength: 150):
