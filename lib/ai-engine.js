...
PANDUAN PEMETAAN KOLOM (LENGKAP & PRESISI):
1. [DATA PRIBADI, KONTAK & LEGALITAS]:
   ...
   - Izin Kerja / Work Authorization: Jawab sesuai 'workAuthorization' (biasanya 'Yes / WNI / Authorized to work').

2. [PENGALAMAN KERJA, PENDIDIKAN & SERTIFIKASI]:
   - Pengalaman Terkini: Ambil posisi & perusahaan dari 'experience[0]'.
   - Total Tahun Pengalaman: Isi dengan angka dari 'preferences.yearsOfExperience'.
   - Pendidikan Terakhir: Ambil dari 'education[0]' (Universitas, Jurusan, Gelar, IPK, Tahun Lulus).
   - Sertifikasi: Ambil nama sertifikat relevan dari 'certifications'.

3. [TAUTAN & PORTOFOLIO]:
   - LinkedIn, GitHub, Portfolio URL, Website: Isi dari data 'links' atau 'personal'.

4. [GAJI & KETERSEDIAAN]:
   - Gaji yang diharapkan: Ambil dari 'preferences.expectedSalary'.
   - Notice Period / Ketersediaan: Ambil dari 'preferences.noticePeriod' / 'earliestStartDate'.
   - Kesediaan Relokasi / Remote: Ambil dari 'preferences.willingToRelocate' / 'remotePreference'.

5. [DROPDOWN / SELECT / RADIO / CHECKBOX]:
   - Pilih salah satu opsi yang PALING RELEVAN dari daftar 'options' yang tersedia.

6. [PERTANYAAN ESAI & SCREENING] (Why join?, Ceritakan pengalaman/proyek, Kelebihan/Kelemahan, Alasan resign, Leadership, Cover Letter):
   - Hubungkan secara spesifik kebutuhan posisi "${jobTitle}" dengan proyek nyata di CV kandidat.
   - Tulis 2-3 kalimat tajam berbobot menggunakan metode STAR (Situation, Task, Action, Result) dan sebutkan angka metrik/dampak nyata.
   - JANGAN gunakan jawaban generik klise.
   - Gunakan Bahasa Indonesia profesional jika form/loker berbahasa Indonesia, atau Bahasa Inggris profesional jika form/loker berbahasa Inggris.

Format Output WAJIB dalam JSON valid murni:
{
  "fields": {
    "ai-field-id-1": "Nilai yang tepat",
    "ai-field-id-2": "Jawaban esai yang meyakinkan"
  }
}`;
  }
